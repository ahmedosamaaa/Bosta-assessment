            ...
            {utilityLinks.map(({ to, label }, index) => (
                <>
                    <NavLink
                        key={to}
                        to={to}
                        className={`relative flex items-center gap-2 text-md font-bold justify-center py-4 md:py-0 border-b border-gray-100 md:border-none w-full md:w-auto hover:text-red-600 transition-colors duration-200 ${
                            index === 0
